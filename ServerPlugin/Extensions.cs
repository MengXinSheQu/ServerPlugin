...
namespace ServerPlugin
{
    ...
    {
        public static List<Team> Foundation = new List<Team>()
        {
            Team.FoundationForces,
            Team.Scientists
        };
        public static List<Team> ChaosInsurgency = new List<Team>()
        {
            Team.ChaosInsurgency,
            Team.ClassD
        };
        public static List<Team> PluginTeam = new List<Team>()
        {
            Team.OtherAlive,
        };
        public static List<Team> DeathTeam = new List<Team>()
        {
            Team.Dead,
        };
        public static List<Team> SCPTeam = new List<Team>()
        {
            Team.SCPs,
        };
